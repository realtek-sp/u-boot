...
enum qfifo_wrrd { RD_CMD = 0, WR_CMD = 1 };
...
#define MR0_VALUE                                \
	((CAL_SETTING << PCTL_EMR0_CASLAT_BFO) | \
...
#define MR0_VALUE                                            \
	((CAL_SETTING << PCTL_EMR0_CASLAT_BFO) | DLL_RESET | \
	 (TWR_AUTO_PRECHARGE << 9))
...
/*MR0*/
#define TWR_AUTO_PRECHARGE_25 1
#define MR0_VALUE	      ((CAL_SETTING << PCTL_EMR0_CASLAT_BFO) | DLL_RESET | 0x000)
...
#endif
#define DCR_VALUE                                                            \
	((DFI_RATIO << PCTL_DCR_DFI_RATE_BFO) |                              \
	 (DRAM_HALF_DQ << PCTL_DCR_HALF_DQ_BFO) |                            \
	 (DRAM_DQ32 << PCTL_DCR_DQ32_BFO) | (DRAM_SDR << PCTL_DCR_SDR_BFO) | \
...
#define CSR_DIS_BIST_MEM                                 \
	((DISABLE_BIST_FUNC << PCTL_CSR_BIST_IDLE_BFO) | \
	 (DISABLE_DT_MODE << PCTL_CSR_DT_IDLE_BFO) |     \
	 (DISABLE_MEMORY_ACCESS << PCTL_CSR_MEM_IDLE_BFO))
#define CSR_MEM_ACCESS_STATE                             \
	((DISABLE_BIST_FUNC << PCTL_CSR_BIST_IDLE_BFO) | \
	 (DISABLE_DT_MODE << PCTL_CSR_DT_IDLE_BFO) |     \
...
#define TPR0_VALUE                                          \
	(((DRAM_TRTP_TCK / DFI_RATIO + DDRC_SET_OFFSET)     \
	  << PCTL_TPR0_TRTP_BFO) |                          \
...
#ifdef CONFIG_DDR_POWER_GATING
#define TPR0_VALUE                                                 \
	((1 << 23) | ((DRAM_TCKE_TCK + 1) << PCTL_TPR0_TCKE_BFO) | \
	 ((DRAM_TRTP_TCK / DFI_RATIO + DDRC_SET_OFFSET)            \
	  << PCTL_TPR0_TRTP_BFO) |                                 \
	 ((DRAM_TWR_PS / PCTL_PERIOD_PS + DDRC_SET_OFFSET)         \
	  << PCTL_TPR0_TWR_BFO) |                                  \
...
/*TPR1*/
#define TPR1_VALUE                                             \
	(((DRAM_TFAW_PS / PCTL_PERIOD_PS + DDRC_SET_OFFSET)    \
	  << PCTL_TPR1_TFAW_BFO) |                             \
...
#else
#define TPR2_VALUE                                                       \
	(((DRAM_TRST_TUS_PS / PCTL_PERIOD_PS / PCTL_TPR2_TIME_UNIT + 10) \
	  << PCTL_TPR2_TRST_US_BFO) |                                    \
	 ((DRAM_TUS_PS / PCTL_PERIOD_PS / PCTL_TPR2_TIME_UNIT + 10)      \
	  << PCTL_TPR2_TUS_BFO) |                                        \
...
#endif
#define MISC_VLAUE                                               \
	((((DRAM_BST_LEN - 4) >> 2) << WRAP_MISC_BST_SIZE_BFO) | \
...
#define DDR_START_STEP1                                            \
	(REG_CLKEN_DCPHY | REG_CLKEN_PLLREG | REG_FORCE_RST_N_RX | \
	 REG_FORCE_RST_N_TX | REF_CMD_RST_N_RX | REF_CMD_RST_N_TX)
...
#define DDR_PHY_PAD_BUS_0_VALUE                                       \
	(EN_DCC | VREF_SEL | VREF_RANGE | VREF_S | VREF_CURRENT_SEL | \
	 VREF_PD | IBIAS_SEL)
...
#define DPI_CTRL_0_SETTING                                                \
	(CMD_PH_SEL_4_CYCLE | CMD_PH_EN | WR_UPDATA_DLY | RD_UPDATA_DLY | \
	 REF_UPDATA_DLY | CAL_SET_MODE)
...
#define MCK_EN_SETTING                                             \
	(DPI_POST_PI_CL | MCK_DQS1_EN | MCK_DQS0_EN | MCK_CMD_EN | \
	 MCK_CLK0_EN | DPI_POST_PI_EN)
#endif
...
#define RX_DQ1_N_DLY 0x0a
#define RX_DQ2_N_DLY 0x08
#define RX_DQ3_N_DLY 0x0a
#define RX_DQ4_N_DLY 0x09
#define RX_DQ5_N_DLY 0x09
#define RX_DQ6_N_DLY 0x0a
#define RX_DQ7_N_DLY 0x0a

#define RX_DQ8_N_DLY  0x09
#define RX_DQ9_N_DLY  0x08
#define RX_DQ10_N_DLY 0x09
#define RX_DQ11_N_DLY 0x09
#define RX_DQ12_N_DLY 0x08
#define RX_DQ13_N_DLY 0x09
#define RX_DQ14_N_DLY 0x09
#define RX_DQ15_N_DLY 0x09
...
#define DDR_PHY_PLL_PI0_VALUE \
	(CLK_PI | (CMD_PI << 8) | (DQS0_PI << 16) | (DQS1_PI << 24))
#define DDR_PHY_PLL_PI1_VALUE \
	(DQS2_PI | (DQS3_PI << 8) | (DQ_PI << 16) | (POST_PI << 24))
#define DDR_PHY_PLL_PI2_VALUE \
	(DQ_PI | (DQ_PI << 8) | (DQ_PI << 16) | (CS0_PI << 24))
#define DDR_PHY_PLL_PI3_VALUE CS1_PI

#define DDR_PHY_POST_PI_EN (DPI_POST_PI_CL | DPI_POST_PI_EN)

#define OESYNC_VALUE                                                   \
	((CLK_OESYNC << 0) | (DQS0_OESYNC << 2) | (DQS1_OESYNC << 3) | \
	 (DQ_OESYNC << 4) | (DQ_OESYNC << 5) | (CS0_OESYNC << 6))

#define DDR_PHY_AFIFO_STR_1_VALUE                                             \
	(AFIFO_STR_1_DEF_VALUE | CMD_RD_STR_NUM | (CMD_RXT_RD_STR_NUM << 4) | \
...
#define DDR_PHY_AFIFO_STR_2_VALUE                                            \
	(RX_RD_STR_NUM_0 | (RX_RD_STR_NUM_1 << 4) | (RX_RD_STR_NUM_2 << 8) | \
	 (RX_RD_STR_NUM_3 << 12))
...
#define DDR_PHY_CMD_ADR_PH_VALUE                                         \
	(CMD_ADR_PH_OPTION | (CKE_1_PH_SEL << 16) | (CKE_PH_SEL << 12) | \
	 (CS_1_PH_SEL << 8) | (CS_PH_SEL << 4) | (CMD_PH_SEL))
...
#define DDR_PHY_DQS_IN_DLY_0_0_VALUE                                 \
	(RX_DQ0_P_DLY | (RX_DQ1_P_DLY << 8) | (RX_DQ2_P_DLY << 16) | \
	 (RX_DQ3_P_DLY << 24))
#define DDR_PHY_DQS_IN_DLY_1_0_VALUE                                 \
	(RX_DQ4_P_DLY | (RX_DQ5_P_DLY << 8) | (RX_DQ6_P_DLY << 16) | \
	 (RX_DQ7_P_DLY << 24))

#define DDR_PHY_DQS_IN_DLY_2_0_VALUE                                 \
	(RX_DQ0_N_DLY | (RX_DQ1_N_DLY << 8) | (RX_DQ2_N_DLY << 16) | \
	 (RX_DQ3_N_DLY << 24))
#define DDR_PHY_DQS_IN_DLY_3_0_VALUE                                 \
	(RX_DQ4_N_DLY | (RX_DQ5_N_DLY << 8) | (RX_DQ6_N_DLY << 16) | \
	 (RX_DQ7_N_DLY << 24))

#define DDR_PHY_DQS_IN_DLY_0_1_VALUE                                  \
	(RX_DQ8_P_DLY | (RX_DQ9_P_DLY << 8) | (RX_DQ10_P_DLY << 16) | \
	 (RX_DQ11_P_DLY << 24))
#define DDR_PHY_DQS_IN_DLY_1_1_VALUE                                    \
	(RX_DQ12_P_DLY | (RX_DQ13_P_DLY << 8) | (RX_DQ14_P_DLY << 16) | \
	 (RX_DQ15_P_DLY << 24))

#define DDR_PHY_DQS_IN_DLY_2_1_VALUE                                  \
	(RX_DQ8_N_DLY | (RX_DQ9_N_DLY << 8) | (RX_DQ10_N_DLY << 16) | \
	 (RX_DQ11_N_DLY << 24))
#define DDR_PHY_DQS_IN_DLY_3_1_VALUE                                    \
	(RX_DQ12_N_DLY | (RX_DQ13_N_DLY << 8) | (RX_DQ14_N_DLY << 16) | \
	 (RX_DQ15_N_DLY << 24))

#define DDR_PHY_DQS_IN_DLY_0_2_VALUE                                    \
	(RX_DQ16_P_DLY | (RX_DQ17_P_DLY << 8) | (RX_DQ18_P_DLY << 16) | \
	 (RX_DQ19_P_DLY << 24))
#define DDR_PHY_DQS_IN_DLY_1_2_VALUE                                    \
	(RX_DQ20_P_DLY | (RX_DQ21_P_DLY << 8) | (RX_DQ22_P_DLY << 16) | \
	 (RX_DQ23_P_DLY << 24))

#define DDR_PHY_DQS_IN_DLY_2_2_VALUE                                    \
	(RX_DQ16_N_DLY | (RX_DQ17_N_DLY << 8) | (RX_DQ18_N_DLY << 16) | \
	 (RX_DQ19_N_DLY << 24))
#define DDR_PHY_DQS_IN_DLY_3_2_VALUE                                    \
	(RX_DQ20_N_DLY | (RX_DQ21_N_DLY << 8) | (RX_DQ22_N_DLY << 16) | \
	 (RX_DQ23_N_DLY << 24))

#define DDR_PHY_DQS_IN_DLY_0_3_VALUE                                    \
	(RX_DQ24_P_DLY | (RX_DQ25_P_DLY << 8) | (RX_DQ26_P_DLY << 16) | \
	 (RX_DQ27_P_DLY << 24))
#define DDR_PHY_DQS_IN_DLY_1_3_VALUE                                    \
	(RX_DQ28_P_DLY | (RX_DQ29_P_DLY << 8) | (RX_DQ30_P_DLY << 16) | \
	 (RX_DQ31_P_DLY << 24))

#define DDR_PHY_DQS_IN_DLY_2_3_VALUE                                    \
	(RX_DQ24_N_DLY | (RX_DQ25_N_DLY << 8) | (RX_DQ26_N_DLY << 16) | \
	 (RX_DQ27_N_DLY << 24))
#define DDR_PHY_DQS_IN_DLY_3_3_VALUE                                    \
	(RX_DQ28_N_DLY | (RX_DQ29_N_DLY << 8) | (RX_DQ30_N_DLY << 16) | \
	 (RX_DQ31_N_DLY << 24))
