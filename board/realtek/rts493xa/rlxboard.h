...
#if defined CONFIG_RTS493XA_BGA240_DDR3_GENERAL || \
	defined CONFIG_RTS493XA_QFN88_DDR3_1GBIT
#define DDR3_1GBIT_DEMOBOARD
#endif

#ifdef CONFIG_RTS493XA_QFN88_DDR3_2GBIT
#define DDR3_2GBIT_DEMOBOARD
#endif

#if defined CONFIG_RTS493XA_BGA173_DDR2_512MBIT || \
	defined CONFIG_RTS493XA_QFN88_DDR2_512MBIT
#define DDR2_MCM
#endif
...
#define RESCUE_UBOOT3_LOAD_SIZE	  0x60000
#ifdef CONFIG_FIT
#ifdef UBOOT_AS_BL33
#define RESCUE_LINUX_LOAD_ADDR (0x80ffc000 - 0x20 - 0x128)
#else
#define RESCUE_LINUX_LOAD_ADDR (0x80ffc000 - 0x20 - 0x88)
#endif
#else
